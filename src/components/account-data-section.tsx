      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Exporte uma cópia de tudo que você cadastrou ou exclua permanentemente sua conta.
          </p>
        </div>
      </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Isso apaga contas, cartões, lançamentos, categorias, patrimônio, conexões bancárias e
              perfis do Telegram — tudo, sem volta. Se quiser guardar uma cópia antes, use "Exportar
              meus dados".
            </AlertDialogDescription>
          </AlertDialogHeader>
