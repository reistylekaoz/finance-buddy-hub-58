    ...
    <main className="mx-auto max-w-3xl px-6 py-12 text-sm leading-relaxed text-foreground">
      ...
      <section className="mt-8 space-y-4">
        ...
        <p>
          ...
          lançamentos, categorias, patrimônio, investimentos e orçamentos, com integrações opcionais
          de sincronização bancária (via Pluggy), notificações por Telegram e compartilhamento de
        ...
        <h2 className="font-display text-xl font-semibold">3. Contas compartilhadas</h2>
        <p>
          Se você convidar outra pessoa para acessar sua conta, ela poderá ver e, conforme a
          permissão concedida, editar seus dados financeiros. Você é responsável por escolher com
          quem compartilha e pode revogar esse acesso a qualquer momento em Configurações. Se você
          aceitar um convite de outra pessoa, os dados que você vir ou editar pertencem à conta
          dela, não à sua.
        </p>

        <h2 className="font-display text-xl font-semibold">4. Integrações de terceiros</h2>
        <p>
        ...
        <h2 className="font-display text-xl font-semibold">5. Isenção de responsabilidade</h2>
        <p>
        ...
        <h2 className="font-display text-xl font-semibold">8. Lei aplicável</h2>
