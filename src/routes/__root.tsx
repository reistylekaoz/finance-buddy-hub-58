...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Contas, receitas, despesas, centros de custo e patrimônio em um só lugar.",
      },
      { name: "author", content: "Fluxora" },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="pt-BR">
      <head>
        {/* Antes de tudo, pra não piscar claro e escurecer só depois da hidratação. */}
...
function RootComponent() {
  ...
  useEffect(() => {
    // Sem cache/offline (ver public/sw.js) — só registrado pra habilitar o
    // prompt nativo de "instalar app" no Chrome/Android.
