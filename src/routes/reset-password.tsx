...
export const Route = createFileRoute("/reset-password")({
  head: () => ({
    meta: [
      { title: "Nova senha | Fluxora" },
      { name: "description", content: "Defina uma nova senha para sua conta Fluxora." },
      { property: "og:title", content: "Nova senha | Fluxora" },
      { property: "og:description", content: "Recupere seu acesso ao Fluxora." },
...
function ResetPassword() {
  ...
  return (
    <main className="grid min-h-screen place-items-center p-6">
      <form
        onSubmit={submit}
        className="w-full max-w-sm rounded-lg border border-border bg-card p-7"
      >
        <img
          src={lightLogo.url}
