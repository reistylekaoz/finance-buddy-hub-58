-- Amplia o escopo do orçamento: além de categoria ou centro de custo,
-- agora também dá pra controlar o orçamento por conta ou por cartão de
-- crédito específico (soma só os lançamentos daquela conta/cartão, sem
-- olhar categoria/centro de custo nesse caso).
